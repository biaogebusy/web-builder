  ...
  body: [
    {
      ...
      content: {
        ...
        body: '<p><span data-type="text">在喧嚣的城市中寻找心灵的绿洲，不二艺术工作室欢迎您！我们专注于为每一位热爱生活的您，提供个性化、高品质的艺术创作空间和课程服务。从零基础绘画课程到高端私人定制艺术品，让您在挥洒色彩间感受生活的美好。</span></p>',
        actions: [
          {
            type: 'btn',
            mode: 'raised',
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          type: 'card-1v5',
          title: '定制艺术作品',
          body: '无论您是企盼家居装饰的艺术画作，还是希望赠予亲友的独特礼品，不二都能根据您的需求，为您量身定制专属的艺术品。',
          more: {
            href: '/node/1',
            target: '_blank',
            label: '查看详情',
