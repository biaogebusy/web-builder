...
const Template: Story<PackeryComponent> = (args) => ({
  component: PackeryComponent,
  props: {
    ...args,
  },
...
Default.args = {
  content: {
    ...
    text: {
      ...
      body: '<p class="text-light text-center">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>',
    },
    bg: {
