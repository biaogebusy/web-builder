...
| 其他 | [管理](#manage)，[电子商务](#commerce)，[移动设备](#mobile)，[社交](#sns)，[发行版](#release)，[SEO](#seo)，[开发](#dev)，[性能](#performance) ，[AI](#ai) |
...
| [transliterate_filenames](https://www.drupal.org/project/transliterate_filenames) | 上传的文件自动改名                                                                                                                                                                       |  1.3w  |
...
| 模块                                                                              | 描述                                                                                                     | 安装量 |
| --------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | :----: |
| [OpenAI / ChatGPT / AI Search Integration](https://www.drupal.org/project/openai) | OpenAI 模块集成了 API 的基础，用于生成文本内容、图像、内容分析，利用该服务，改变管理内容和维护任务的方式 |   74   |
...
| [Drupal jsonapi params](https://github.com/d34dman/drupal-jsonapi-params)                              | drupal jsonapi 参数构造器                                     | 40  |
