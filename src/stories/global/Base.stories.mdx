...
<Meta title="全局配置/基础配置" id="base-config" />
...
```json
{
  ...
  "login": {
    ...
    "left": {
      "type": "img",
      "src": "/assets/images/login-second.png",
      "alt": "登录"
    },
    "phoneLogin": {
      "enable": true,
...
```json
{
  ...
  "apiUrl": {
    ...
    "github": {
      "repos": "https://github.com/biaogebusy/xinshi-angular",
      "api": "https://api.github.com/repos/biaogebusy/xinshi-angular"
    }
  }
}
```
