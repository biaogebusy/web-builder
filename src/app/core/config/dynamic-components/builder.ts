...
export { WidgetPickerComponent } from '@modules/builder/main/widget-picker/widget-picker.component';
export {
  LayoutSettingComponent,
} from '@modules/builder/toolbar/layout-setting/layout-setting.component';
export {
  BuilderTemplateComponent,
} from '@modules/builder/main/builder-template/builder-template.component';
